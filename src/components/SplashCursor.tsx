...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Enhanced color generation with portfolio theme colors
      const colorPalettes = [
        // Violet/Purple theme
        { h: 0.75 + Math.random() * 0.1, s: 0.8 + Math.random() * 0.2, v: 0.6 + Math.random() * 0.4 },
        // Green theme
        { h: 0.3 + Math.random() * 0.1, s: 0.7 + Math.random() * 0.3, v: 0.5 + Math.random() * 0.5 },
        // Red/Pink theme
        { h: 0.95 + Math.random() * 0.1, s: 0.8 + Math.random() * 0.2, v: 0.6 + Math.random() * 0.4 },
        // Cyan/Blue theme
        { h: 0.5 + Math.random() * 0.1, s: 0.7 + Math.random() * 0.3, v: 0.5 + Math.random() * 0.5 },
      ];
      
      const palette = colorPalettes[Math.floor(Math.random() * colorPalettes.length)];
      let c = HSVtoRGB(palette.h, palette.s, palette.v);
